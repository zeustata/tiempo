...
- Botón Universal de Apagado / Salida (⏻) & Optimización de CPU/RAM en segundo plano: Situado al final de las tarjetas en "Estación en Vivo" y en el Menú desplegable a sugerencia de beta tester con teléfono antiguo (modo inmersivo de pantalla completa). Pausa instantánea de partículas en segundo plano sin alterar la calidad gráfica máxima de la app, manteniendo la versión oficial en v1.0.81 (SW `v181-exit-power`).
