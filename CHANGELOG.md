...
- **Service Worker `v181-cleantext-v2` & Cache-Busting**: Actualización a `?v=1.0.81-cleantext-v2` con renovación del query string del import de `weatherExplanations.js` en `app.js` para forzar la invalidación inmediata de caché en navegadores locales.
