import { CONCEJOS_ASTURIAS, getConcejoById, findClosestConcejo } from './config/concejos.js?v=4.8';
import { fetchWeatherData } from './services/weatherApi.js?v=4.8';
import { getPreferences, savePreferences, toggleFavorite, isFavorite } from './utils/storage.js?v=4.8';
import { renderCurrentWeather } from './components/currentCard.js?v=4.8';
import { renderMarineCard } from './components/marineCard.js?v=4.8';
import { renderMountainCard } from './components/mountainCard.js?v=4.8';
import { renderForecast } from './components/forecastView.js?v=4.8';
import { renderWeatherChart } from './components/chartsView.js?v=4.8';
import { renderCompareView } from './components/compareView.js?v=4.8';
import { initAsturiasMap, playRadarAnimation, focusConcejoOnMap, resizeMap, resetMapCenter } from './components/mapRadar.js?v=4.8';
import { getWeatherInfo } from './utils/weatherIcons.js?v=4.8';
