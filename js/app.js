import { CONCEJOS_ASTURIAS, getConcejoById, findClosestConcejo } from './config/concejos.js?v=1.0.52';
import { fetchWeatherData, WEATHER_MODELS, getModelById, getDefaultModel } from './services/weatherApi.js?v=1.0.52';
import { getPreferences, savePreferences, toggleFavorite, isFavorite } from './utils/storage.js?v=1.0.52';
import { renderCurrentWeather } from './components/currentCard.js?v=1.0.52';
import { renderMarineCard } from './components/marineCard.js?v=1.0.52';
import { renderMountainCard } from './components/mountainCard.js?v=1.0.52';
import { renderForecast } from './components/forecastView.js?v=1.0.52';
import { renderWeatherChart } from './components/chartsView.js?v=1.0.52';
import { renderAstronomyView } from './components/astronomyCard.js?v=1.0.52';
import { initAsturiasMap, playRadarAnimation, focusConcejoOnMap, resizeMap, resetMapCenter } from './components/mapRadar.js?v=1.0.52';
import { getWeatherInfo } from './utils/weatherIcons.js?v=1.0.52';
import { getAsturWeatherSvg } from './utils/weatherAsturIcons.js?v=1.0.52';
import { getPixelWeatherSvg } from './utils/weatherPixelIcons.js?v=1.0.52';
import { getNeonWeatherSvg } from './utils/weatherNeonIcons.js?v=1.0.52';
import { getSketchWeatherSvg } from './utils/weatherSketchIcons.js?v=1.0.52';
import { getExplanationHtml, WEATHER_EXPLANATIONS } from './utils/weatherExplanations.js?v=1.0.52';
