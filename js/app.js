import { CONCEJOS_ASTURIAS, getConcejoById, findClosestConcejo } from './config/concejos.js?v=5.7';
import { fetchWeatherData } from './services/weatherApi.js?v=5.7';
import { getPreferences, savePreferences, toggleFavorite, isFavorite } from './utils/storage.js?v=5.7';
import { renderCurrentWeather } from './components/currentCard.js?v=5.7';
import { renderMarineCard } from './components/marineCard.js?v=5.7';
import { renderMountainCard } from './components/mountainCard.js?v=5.7';
import { renderForecast } from './components/forecastView.js?v=5.7';
import { renderWeatherChart } from './components/chartsView.js?v=5.7';
import { renderCompareView } from './components/compareView.js?v=5.7';
import { initAsturiasMap, playRadarAnimation, focusConcejoOnMap, resizeMap, resetMapCenter } from './components/mapRadar.js?v=5.7';
import { getWeatherInfo } from './utils/weatherIcons.js?v=5.7';
