import { CONCEJOS_ASTURIAS, getConcejoById, findClosestConcejo } from './config/concejos.js?v=1.0.23';
import { fetchWeatherData, WEATHER_MODELS, getModelById, getDefaultModel } from './services/weatherApi.js?v=1.0.23';
import { getPreferences, savePreferences, toggleFavorite, isFavorite } from './utils/storage.js?v=1.0.23';
import { renderCurrentWeather } from './components/currentCard.js?v=1.0.23';
import { renderMarineCard } from './components/marineCard.js?v=1.0.23';
import { renderMountainCard } from './components/mountainCard.js?v=1.0.23';
import { renderForecast } from './components/forecastView.js?v=1.0.23';
import { renderWeatherChart } from './components/chartsView.js?v=1.0.23';
import { renderAstronomyView } from './components/astronomyCard.js?v=1.0.23';
import { initAsturiasMap, playRadarAnimation, focusConcejoOnMap, resizeMap, resetMapCenter } from './components/mapRadar.js?v=1.0.23';
import { getWeatherInfo } from './utils/weatherIcons.js?v=1.0.23';
import { getExplanationHtml, WEATHER_EXPLANATIONS } from './utils/weatherExplanations.js?v=1.0.23';
