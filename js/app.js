import { CONCEJOS_ASTURIAS, getConcejoById, findClosestConcejo } from './config/concejos.js?v=6.3';
import { fetchWeatherData } from './services/weatherApi.js?v=6.3';
import { getPreferences, savePreferences, toggleFavorite, isFavorite } from './utils/storage.js?v=6.3';
import { renderCurrentWeather } from './components/currentCard.js?v=6.3';
import { renderMarineCard } from './components/marineCard.js?v=6.3';
import { renderMountainCard } from './components/mountainCard.js?v=6.3';
import { renderForecast } from './components/forecastView.js?v=6.3';
import { renderWeatherChart } from './components/chartsView.js?v=6.3';
import { renderCompareView } from './components/compareView.js?v=6.3';
import { initAsturiasMap, playRadarAnimation, focusConcejoOnMap, resizeMap, resetMapCenter } from './components/mapRadar.js?v=6.3';
import { getWeatherInfo } from './utils/weatherIcons.js?v=6.3';
